...
def run_inference(in_meta):
  ...
  #output
  global _clf
  retval = _clf.predict_proba([in_meta['scores']['sadness'],
                               in_meta['scores']['neutral'],
                               in_meta['scores']['contempt'],
                               in_meta['scores']['disgust'],
                               in_meta['scores']['anger'],
                               in_meta['scores']['surprise'],
                               in_meta['scores']['fear'],
                               in_meta['scores']['happiness']]
                              )
  print retval
  return retval
...
@app.route('/predictConfusion', methods=['GET'])
def predictConfusion(in_meta):
  # error = None
